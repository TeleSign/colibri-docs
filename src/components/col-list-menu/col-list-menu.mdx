  ...
  <div className="col-doc__container">
    ...
    * **List with icons**:	Use icons when you think necessary to give more context to each of the list copies, this as a visual aid for the user.
    ...
    <Callout variant="info" icon="ℹ️">
      ...
      * "Marking" an option as `selected` is left up to the developer at time of implementation since ColListMenu's with "menu" role do not need it. Please see the code snippet for an example of how to handle it.
    </Callout>
    ...
    <Callout variant='info' icon='ℹ️'>
      <p>Open "Show code" to see Javascript example special Checkbox single select state and event management.</p>
    </Callout>
    ...
    <Callout variant='info' icon='ℹ️'>
      <p>Open "Show code" to see Javascript example special Checkbox multiple select state and event management.</p>
    </Callout>
    ...
    <Callout variant='info' icon='ℹ️'>
      <p>Open "Show code" to see Javascript example special Radio single select state and event management.</p>
    </Callout>

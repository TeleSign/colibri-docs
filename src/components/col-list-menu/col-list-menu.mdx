...
import * as ListItemStories from './col-list-menu.stories';
...
<div className="col-doc__wrapper">
  <div className="col-doc__container">
    ...
    * **List with icons**:	Use icons when you think necessary to give more context to each of the list copies, this as a visual aid for the user.
    ...
    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.Default} />
    ...
    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuWithLabelItems} />
    ...
    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuWithNavigation} />

    #### Using ColIcon
    `col-list-menu-item`s may include ColIcons to visually aid with the option description
    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuItemsWithIcons} />

    ### Using ColCheckbox
    `col-list-menu-item`s may require additional selection input components like ColCheckbox

    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuCheckbox} />

    If the `col-list-menu` has `multiselectable` attribute, then the list will allow for multiple items to be selected

    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuCheckboxWithMultiSelect} />
    ...
    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuRadio} />
...
## Slots
    ...
    * The `default` slot is where we want to make sure we add the `<col-list-menu-item>` to represent the options in the `col-list-menu`.
    ...
    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuSlots} />
    ...
    * The `default` slot is the content for the `col-list-menu-item` itself.
    ...
    <Callout variant='info' icon='ℹ️'>
      When using a ColButton in the `list-menu-item-slot`, make sure you add the necessary code to capture the events. To see sample code, please open the "Show code" option; or view <LinkTo title={ListItemStories.default.title} story="list-menu-item-slots">the story</LinkTo> for an interactive example.
    </Callout>

    <Canvas className="col-doc__canvas--with-background" of={ListItemStories.ListMenuItemSlots} />
    ...
    To interact with the component, test actions, verify accessibility compliance, and perform visual testing, navigate to the <LinkTo title={ListItemStories.default.title} story="default">Default</LinkTo> section.
